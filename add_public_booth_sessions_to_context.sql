...
select
  jsonb_array_length(coalesce(public.get_public_event_context()->'booth_sessions', '[]'::jsonb)) as booth_session_count,
  public.get_public_event_context() ? 'booth_sessions' as has_booth_sessions;
