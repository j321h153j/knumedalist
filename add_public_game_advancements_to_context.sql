...
select
  public.get_public_event_context() ? 'game_advancements' as has_game_advancements,
  jsonb_array_length(coalesce(public.get_public_event_context()->'game_advancements', '[]'::jsonb)) as game_advancement_count;
